...
function Joined_Accompany(){
  ...
  useEffect(() => {
    const method = "/app_accompany/accom_joined_list/"+localStorage.mem_userid;
...
export function ListAcom(props){
  return(
    <Link to={{
        pathname : '/Info/'+props.idx,
        state : {
            previousPathName : "Joined_Accompany" 
        }    
    }}>
...
export default Joined_Accompany;
